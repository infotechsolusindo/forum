<?php echo $data['header']; ?>
        ...
        <div id="main" class="col-md-10 col-sm-10">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <form action="?url=pendaftaranmember/index&cmd=save" method="post" enctype="multipart/form-data">
                <!-- Form -->
                <div class="form">
                  <p>
                    <span class="req"></span>
                    <label>Email <span></span></label>
                    <input type="hidden" name="email" value="<?php echo $data['member']->getEmail(); ?>" />
                    <label><?php echo $data['member']->getEmail(); ?></label>
                  </p>
                  <p>
                    <span class="req"></span>
                    <label>NRA <span></span></label>
                    <input type="text" name="nra" class="field size1" value="<?php echo $data['member']->getNRA(); ?>" />
                  </p> 
                  <p>
                    <span class="req"></span>
                    <label>Nama Panggilan <span></span></label>
                    <input type="text" name="namapanggilan" class="field size1" value="<?php echo $data['member']->getNamaPanggilan(); ?>" />
                  </p>
                  <p>
                    <span class="req"></span>
                    <label>Nama Lengkap <span>(Wajib diisi)</span></label>
                    <input type="text" name="namalengkap" class="field size1" value="<?php echo $data['member']->getNamaLengkap(); ?>" />
                  </p>
                  <p>
                    <span class="req"></span>
                  ...
                  <p>
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <input type="text" name="tempatlahir" class="form-control" placeholder="Tempat" value="<?php echo $data['member']->getTempatLahir(); ?>" />
                      </div>
                      <div class="col-sm-3">
                  ...
                  <p>
                    ...
                    <input type="text" name="telp" class="field size1" value="<?php echo $data['member']->getNomerPonsel(); ?>" />
                  </p>
                  <p>
                    <span class="req"></span>
    ...
    ?>
                  ...
                  <p>
                    ...
                    <input type="text" name="pekerjaan" class="field size1" value="<?php echo $data['member']->getPekerjaan(); ;;?>" />
                  </p>
                  <p>
                    <span class="req"></span>
                    <label>Institusi</label>
                    <input type="text" name="institusi" class="field size1" value="<?php echo $data['member']->getInstitusi(); ?>" />
                  </p>
                  <p>
                    <span class="req"></span>
                    <label>Jabatan</label>
                    <input type="text" name="jabatan" class="field size1" value="<?php echo $data['member']->getJabatan(); ;?>" />
                  </p>
                  <p>
                    <label>Foto </label>
                    <img src="<?php echo $data['member']->getFoto(); ?>" height="100px"/>
