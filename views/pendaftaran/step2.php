        ...
        <div id="main" class="col-md-10 col-sm-10">
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <form action="?url=pendaftaran/index&cmd=save2" method="post" enctype="multipart/form-data">
                <!-- Form -->
                <div class="form">
                  <p>
                    ...
                    <?php if (isset($data['dokumen'][$daftar->tipe])) {?>
                        <tr>
                          ...
                          <td><a href="?url=pendaftaran/index/dokumen/hapus/<?=$data['dokumen'][$daftar->tipe]->iddokumen;?>">hapus</a></td>
                        </tr>
                    <?php } else {?>
